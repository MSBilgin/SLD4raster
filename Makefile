...
# translation
SOURCES = sld4raster.py ui_sld4raster.py __init__.py sld4rasterdialog.py
#TRANSLATIONS = i18n/sld4raster_en.ts
TRANSLATIONS =

# global

PLUGINNAME = sld4raster

PY_FILES = sld4raster.py sld4rasterdialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_sld4raster.py
